...
export class PianoSynthesizer {
  ...
  createPianoSound(frequency: number): { oscillators: OscillatorNode[]; gainNode: GainNode; noiseNode?: AudioBufferSourceNode } {
    ...
    if (frequency < 1000) { // Only add noise to lower notes
